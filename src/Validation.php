...
namespace olakunlevpn\AddressValidator;

use olakunlevpn\AddressValidator\Exception\CryptocurrencyValidatorNotFound;
...
abstract class Validation {
    ...
    public static function make($iso) {
        $class = 'olakunlevpn\AddressValidator\Validation\\' . strtoupper($iso);
